      ...
      <div className="max-w-7xl 2xl:max-w-none mx-auto px-4 sm:px-6 lg:px-8 2xl:px-20">
        <div className="grid gap-8 md:grid-cols-2 md:gap-12 items-center">
          <img
            ...
            loading="lazy"
            decoding="async"
            className={`w-full h-auto sm:w-2/3 md:w-full max-w-full sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto rounded-xl shadow-lg shadow-black/60 object-cover transition-all duration-700 ${
