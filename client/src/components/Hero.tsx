...
const [brainAscending, setBrainAscending] = useState(false);
  ...
  return (
    ...
    >
        ...
        <div
          className={`relative mt-0 md:mt-2 lg:mt-0 xl:-mt-2 h-52 sm:h-60 md:h-72 lg:h-80 xl:h-96 2xl:h-[28rem] flex flex-col items-center justify-center transform translate-y-36 sm:translate-y-32 md:translate-y-28 lg:translate-y-24 xl:translate-y-24 2xl:translate-y-24 ${
