...
const [brainAscending, setBrainAscending] = useState(false);
  ...
  return (
    ...
    >
        ...
        >
            <h1 className="text-center text-[2.6rem] sm:text-5xl md:text-6xl lg:text-7xl 2xl:text-8xl font-bold mb-6 lg:mt-8 leading-tight">
        ...
        <div
          className={`relative mt-0 md:mt-2 lg:mt-0 xl:-mt-2 h-52 sm:h-60 md:h-72 lg:h-80 xl:h-96 2xl:h-[28rem] flex flex-col items-center justify-center transform translate-y-48 sm:translate-y-32 md:translate-y-28 lg:translate-y-48 xl:translate-y-48 2xl:translate-y-48 ${
